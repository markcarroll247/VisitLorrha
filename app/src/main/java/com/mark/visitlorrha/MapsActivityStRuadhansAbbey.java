...
public class MapsActivityStRuadhansAbbey extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_activity_st_ruadhans_abbey);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(stRuadhansAbbey, 15)); //centres camera and zooms in
