...
public class MapsActivityAugustinianAbbey extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_activity_augustinian_abbey);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(augustinianAbbey, 15)); //centres camera and zooms in
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home: // to show up/back button in the action bar
                finish();
                break;
        }
