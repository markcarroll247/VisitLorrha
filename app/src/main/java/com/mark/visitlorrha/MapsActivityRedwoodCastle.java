...
public class MapsActivityRedwoodCastle extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_activity_redwood_castle);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng redwoodCastle = new LatLng(53.138997, -8.105851);
        ...
        mMap.addMarker(new MarkerOptions()
                .position(redwoodCastle)
                .title("Redwood Castle")
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_VIOLET)));

        //positioning the camera
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(redwoodCastle, 12)); //centres camera and zooms in
